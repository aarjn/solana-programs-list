...
| Merkle Tree      | Incremental Merkle tree with insert & proof verification               | `Merkle Tree` `Hashing` `Proof Verification`                      | NIL       | NIL      | NIL    | [✨ Program](https://github.com/4rjunc/solana-programs-list/tree/main/quasar-merkle-tree) 🟢 ✅ |
